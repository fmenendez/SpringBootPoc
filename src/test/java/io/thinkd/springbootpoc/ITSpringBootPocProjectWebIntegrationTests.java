...
@SpringBootTest(classes = SpringBootPocProjectApplication.class, webEnvironment = WebEnvironment.DEFINED_PORT)
public class ITSpringBootPocProjectWebIntegrationTests {
